...
import Muscular from '../Muscular/Muscular.js'
import Superiores from '../Muscular/Superiores.js';
import Cultaneos from '../Muscular/Cultaneos';
    ...
    <>
      ...
      <main>
        <Switch>
          ...
          <Route exact path="/cultaneos" render={(props) => <Cultaneos />}></Route>
        </Switch>
      </main>
